...
There have been quite a few [neat discussions happening][] on the forums as well.
...
[neat discussions happening]: https://discuss.pixls.us/latest?order=views
...
I figure @LebedevRI will yell at me if I forget to mention [raw.pixls.us](https://raw.pixls.us) again.
...
Earlier this year the [digiKam][] team were needing to migrate their old Drupal website to something more modern (and secure) and @paperdigits figured, _"why not"_?
...
This way their users can still own their own comments and we can manage spam and moderate things for them.
...
Mr. @paperdigits also has a great attitude and pro-active approach to the community which I am super thankful for.
