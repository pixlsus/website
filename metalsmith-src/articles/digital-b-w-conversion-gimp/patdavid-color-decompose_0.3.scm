...
(define (script-fu-patdavid-color-decompose Image Drawable)
	...
	(let*
      ...
      ; YCbCr ITU R470 256
      (define tmp (plug-in-decompose 1 Image Drawable "YCbCr_ITU_R470_256" 0))
      ...
      ; YCbCr ITU R709 256
      (define tmp (plug-in-decompose 1 Image Drawable "YCbCr_ITU_R709_256" 0))
